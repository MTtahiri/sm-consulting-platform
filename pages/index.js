...
function ContactInput({ id, label, name, type = 'text', value, onChange, required = false }) {
  return (
    <div style={{ marginBottom: '1.5rem' }}>
      <label htmlFor={id} style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500', color: '#1a365d' }}>
        {label}
      </label>
      <input
        type={type}
...
// SUPPRIMEZ l'autre fonction export default qui se trouve à la fin du fichier
